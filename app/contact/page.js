				...
				<div className='grid lg:grid-cols-2 gap-10 lg:gap-16'>
					...
					<motion.div
						...
						<div className='space-y-7'>
							...
							<motion.div
								...
								<div className='flex-shrink-0 w-10 h-10 sm:w-12 sm:h-12 bg-accent/10 rounded-xl flex items-center justify-center group-hover:bg-accent/20 transition-all duration-300'>
									<svg
					...
					<motion.div
						...
						<div className='space-y-6'>
							{/* Form fields remain unchanged except minor mobile spacing */}
							<div>
